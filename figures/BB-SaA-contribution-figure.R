...
sizetrends<-read.csv("SaA_contribution_by_system.csv")[,-1]
sizetrends<-sizetrends[order(match(sizetrends$stock,rivers)),]
sizetrend<-read.csv("SaA_contribution_BB_wide.csv")[,-1]

##==================================================## plot contributions
pdf("Size-change-contributions.pdf",width=5,height=4)
